...
const inline std::vector<testitem> simple_puzzles_handmade = {
  {{"3k3r/pp1r3p/8/8/6n1/8/2PPP3/2NKRR2 b - - 0 1", false},
   {Move(SQ_G4, SQ_E3)},
   4,
   true,
  ...
  {{"k6r/8/3B4/6P1/4n3/2P5/1K3R2/8 b - - 0 1", false},
   ...
   true,
   GameEndDetector::GameEnd::BlackWin},
  {{"4k3/8/8/8/1n6/3N4/8/R3K3 b - - 0 1", false},
   {Move(SQ_B4, SQ_C2)},
   5,
   true,
   GameEndDetector::GameEnd::None},
  {{"4k3/8/8/8/1n6/3N4/8/R3K3 b - - 0 1", false},
   {Move(SQ_B4, SQ_C2)},
   5,
   true,
   GameEndDetector::GameEnd::None},
  {{"4k3/r7/8/8/4n1PK/8/8/8 b - - 0 1", false},
   {Move(SQ_A7, SQ_H7)},
   4,
   true,
   GameEndDetector::GameEnd::BlackWin},
  {{"4k3/r7/8/8/4n1PK/8/8/8 b - - 0 1", false},
   ...
   true,
   GameEndDetector::GameEnd::BlackWin},
  {{"r3k3/8/1b6/3N4/8/8/8/4K3 w - - 0 1", false},
   {Move(SQ_D5, SQ_C7)},
   4,
   true,
   GameEndDetector::GameEnd::None},
  {{"r3k3/8/1b6/3N4/8/8/8/4K3 w - - 0 1", false},
   ...
   true,
   GameEndDetector::GameEnd::None},
  {{"8/7R/8/kp1N4/6PK/8/8/8 w - - 0 1", false},
   {Move(SQ_H7, SQ_A7)},
   4,
   true,
   GameEndDetector::GameEnd::WhiteWin},
  {{"8/7R/8/kp1N4/6PK/8/8/8 w - - 0 1", false},
   {Move(SQ_H7, SQ_A7)},
   5,
   true,
   GameEndDetector::GameEnd::WhiteWin},
  {{"r3k3/8/1n6/3N4/8/8/8/4K3 w - - 0 1", false},
   {Move(SQ_D5, SQ_B6)},
   4,
   true,
   GameEndDetector::GameEnd::None},
...
const inline std::vector<testitem> book_puzzles = {
  ...
  {{"QRn4k/3P1PR1/1q1pb1PP/5pp1/1NP2bnp/3P3P/Qq1N1qK1/q4B1r b 0 10", false},
   ...
   false,
   GameEndDetector::Draw},
  {{"8/8/8/1k6/8/1KQ5/8/q7 w - - 0 1", false}, {}, 5, true, GameEndDetector::WhiteWin},
  {{"8/8/8/2k5/8/1KQ5/8/q7 w - - 0 1", false}, {}, 13, true, GameEndDetector::WhiteWin},
  {{"6k1/8/6K1/8/8/2Q5/8/q7 w - - 0 1", false}, {}, 35, false, GameEndDetector::WhiteWin},
  {{"8/8/8/3k4/8/1KQ5/8/q7 w - - 0 1", false}, {}, 80, false, GameEndDetector::WhiteWin},
  {{"8/8/2k5/8/1K6/2Q5/8/q7 w - - 0 1", false}, {}, 80, false, GameEndDetector::WhiteWin},
  {{"8/8/3k4/8/1K6/2Q5/8/q7 w - - 0 1", false}, {}, 80, false, GameEndDetector::WhiteWin},
  {{"8/8/8/8/8/2K1k3/8/q1Q5 w - - 0 1", false}, {}, 80, false, GameEndDetector::WhiteWin},
  {{"8/8/8/8/8/8/2K1k3/q1Q5 w - - 0 1", false}, {}, 80, false, GameEndDetector::WhiteWin},
  {{"1n1r4/p1kP3P/2pNb1Pb/PPPqP3/3P2R1/1pnBB1R1/r5Q1/2K5 w - - 0 1", false},
   {},
   80,
   false,
   GameEndDetector::WhiteWin},
  {{"1qr1kr2/5p2/2P1b1p1/pP4Bp/np2N2R/n1pP2P1/P3QP2/KBq1NR2 w - - 0 1", false},
   {},
   19,
   false,
   GameEndDetector::WhiteWin},
  {{"1n1r4/2kP3P/1ppNb1Pb/P1PqP3/3P2R1/1pnBB1R1/r5Q1/2K5 w - - 0 1", false},
   {},
   19,
   true,
   GameEndDetector::WhiteWin},
  {{"2rrnb2/8/bRp1pppp/k1n5/p1P3p1/P1KQB1PP/1RNPN3/5B2 b - - 0 1", false},
   {},
   19,
   true,
   GameEndDetector::BlackWin},
  {{"1rb3k1/2Pp2PP/3N4/2Bp1Q2/1p1nP3/p7/1rPpPpR1/KBn1N1q1 b - - 0 1", false},
   {},
   19,
   false,
   GameEndDetector::WhiteWin},
  {{"1rb3Q1/2Pp4/3N3k/2Bp1Q2/1p1nP3/p7/1rPpPpR1/KBn1N1q1 w - - 0 1", false},
   {},
   19,
   true,
   GameEndDetector::WhiteWin},
